  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        {/* Round Image */}
        <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full mb-4 overflow-hidden border-2 border-[#a855f7]/50">
          <img 
            src={imageUrl} 
            alt={name}
            loading="lazy"
        ...
        {/* Name */}
        <h3 className="text-base sm:text-lg font-bold font-['Orbitron'] text-white mb-1 text-center group-hover:text-[#a855f7] transition-colors duration-300">
          {name}
        </h3>

        {/* Designation */}
        <p className="text-xs text-[#a855f7] mb-4 font-['Space_Grotesk'] uppercase tracking-wider">
          Lead Developer
        </p>
        ...
        <div className="flex items-center gap-4">
          ...
          <a 
            ...
            title={phone}
          >
            <Phone className="size-4 sm:size-5 text-[#00d4ff]" />
          </a>
          ...
          <a 
            ...
            title={email}
          >
            <Mail className="size-4 sm:size-5 text-[#00d4ff]" />
          </a>
          ...
          <a 
            ...
            title={github}
          >
            <Github className="size-4 sm:size-5 text-[#00d4ff]" />
          </a>
        </div>
      </div>
    </motion.div>
        ...
        <div className="flex items-center gap-3">
          ...
          {linkedin ? (
            ...
            <a 
              ...
              title={instagram}
            >
              <Instagram className="size-3 sm:size-4 text-[#00d4ff]" />
            </a>
          )}
        </div>
      </div>
...
const coordinators = [
  ...
  // Blitz
  { event: 'Blitz', name: 'Soham Ghosh', phone: '+91 6290187678', email: 'sohamghosh1762@gmail.com', instagram: '@_sg_2200', imageUrl: 'https://instagram.fccu5-1.fna.fbcdn.net/v/t51.82787-15/572887565_17903007393277369_1523609789060724585_n.webp?_nc_cat=108&ig_cache_key=Mzc1ODUwMjkyOTk2MDc4ODk2Nw%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjEzOTF4MTQ0MC5zZHIuQzMifQ%3D%3D&_nc_ohc=J-HzQegiYl4Q7kNvwFqC1Ef&_nc_oc=AdlC9-y4hW6svlCmVSFu_g5SPyTroECPWBGyog6VL1cEktSOcVGR92B2uVwXkalxuJ0&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=instagram.fccu5-1.fna&_nc_gid=Zvl7jLupG2afqcwfgIXopA&oh=00_AftkbGM_WMhz_uAn7yJXznSyaXk3RgcFBC7NJ07BIo2m6Q&oe=69A28673', icon: Lightbulb },
  // PES
  { event: 'PES', name: 'Avirup Ghosh', phone: '+91 7003357906', email: 'avirupghosh751@gmail.com', instagram: '@Cloudy_aviiz', imageUrl: 'https://instagram.fccu5-1.fna.fbcdn.net/v/t51.82787-15/625024138_18103269616831304_1142472499321667865_n.jpg?stp=dst-jpg_e35_tt6&_nc_cat=102&ig_cache_key=MzUzODE4NjkxMDY1OTQ2NzA1NQ%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjE0NDB4MTQ0MC5zZHIuQzMifQ%3D%3D&_nc_ohc=Sg27fC5aHiIQ7kNvwFpKnS8&_nc_oc=Adm5k36XA8irHj8zb_8bz6lvBVoYYUf3202jWe179Y9o_T5wuKzF8B1re5nD1qdr3gs&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=instagram.fccu5-1.fna&_nc_gid=dIGbhFZvrkDyHvaS1o3TAg&oh=00_Aft1KuBnmqvf8R4n-HtGwR4rTWtrRopENRwGxxUHYSYLjw&oe=69A321B8', icon: Gamepad2 },
  // BGMI
  { event: 'BGMI', name: 'Abhik Chatterjee', phone: '+91 9733549955', email: 'abhikchatterjee879@gmail.com', instagram: '@mrchatterjee13', imageUrl: 'https://res.cloudinary.com/dyeglgnfd/image/upload/v1771872418/DSC_0337_c9uzra.jpg', icon: Gamepad2 },
  { event: 'BGMI', name: 'Sayan Roy', phone: '+91 9674363753', email: 'roysamirroysamir9998@gmail.com', linkedin: 'https://www.linkedin.com/in/sayan-roy-266046303/', imageUrl: 'https://media.licdn.com/dms/image/v2/D4D03AQELwWCeOaaJNw/profile-displayphoto-crop_800_800/B4DZw9Jm2AGQAM-/0/1770552457350?e=1773273600&v=beta&t=XrNxxFy5j7Df0fmAbAknoXF1m1gX2jiv4aYSxjlVH_Q', icon: Gamepad2 },
  // Free Fire
  { event: 'Free Fire', name: 'Prabhat Kr Routh', phone: '+91 9332165957', email: 'prabhatkrrouth@gmail.com', instagram: '@prabhatkrrouth', linkedin: '', imageUrl: 'https://media.licdn.com/dms/image/v2/D5603AQGh4elQvdbDZg/profile-displayphoto-scale_400_400/B56ZqxkbyOHAAg-/0/1763915712567?e=1773273600&v=beta&t=I1tNDtcPdF4pXC3PlD3tTTB3k_YwLroiY6w5PHEEpBs', icon: Gamepad2 },
  { event: 'Free Fire', name: 'Ankush Khan', phone: '+91 9064336298', email: 'khanankush483@gmail.com', instagram: '@ankush28_05', imageUrl: 'https://scontent.fccu5-1.fna.fbcdn.net/v/t39.30808-6/484330602_1154811956189493_7444861704957941689_n.jpg?stp=cp6_dst-jpg_tt6&_nc_cat=100&ccb=1-7&_nc_sid=2a1932&_nc_ohc=VCIQokTgeVIQ7kNvwFqPKxB&_nc_oc=AdlBkfqOQNBISZTf6k2VBkjUDTKbTivrCxqnySUQiCUoR-fh5piERTf85j9Fp438o-c&_nc_zt=23&_nc_ht=scontent.fccu5-1.fna&_nc_gid=cqCUSdLJGeSpK6iWqDzg0A&oh=00_AfvWMD8ra64J6cHaDcSdfTp_8mHD3qo8zYMsuZ0E-SKFaw&oe=69A27B7F', icon: Gamepad2 },
  // Valorant
  { event: 'Valorant', name: 'Deep Chatterjee', phone: '+91 6291661608', email: 'deeparduino@gmail.com', instagram: '@deepchatterjee62', imageUrl: 'https://instagram.fccu5-1.fna.fbcdn.net/v/t51.82787-15/547774575_18071064155127003_9211367352663487269_n.webp?_nc_cat=104&ig_cache_key=MzcyMTYxODM4MzEwNTU3NjA3Mw%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjEwODB4NzIwLnNkci5DMyJ9&_nc_ohc=CcZVI2D8uLoQ7kNvwFk0V5f&_nc_oc=Adld2zPRnjUvjioeTkDVf2gvKQCKmpCuzx05nAghgGzKKa3oId2kQkPRT2EPOQweikw&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=instagram.fccu5-1.fna&_nc_gid=baFfeJj0LrEdyrDD4j8IyQ&oh=00_Aft-7fNlYSR9YE4KTSHNZQH1TheYpeK1qJQPCZVtHrWRww&oe=69A277F0', icon: Gamepad2 },
  { event: 'Valorant', name: 'Abhishek Banerjee', phone: '+91 8642019746', email: 'abhishekbaner5@gmail.com', instagram: '@me_abhishek086', imageUrl: 'https://instagram.fccu5-1.fna.fbcdn.net/v/t51.82787-15/610315939_18154898002424400_4613162198759539041_n.jpg?stp=dst-jpg_e35_tt6&_nc_cat=111&ig_cache_key=MzgwMzUwNTg2ODQ1ODQwNTAwOQ%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjY4MXg5MTcuc2RyLkMzIn0%3D&_nc_ohc=oMNBCrbQZ5YQ7kNvwEC6CxU&_nc_oc=Admg62fkWHQAfk81Z7r3yeOqTtA07p081SzqI3bdtvnaEP5fzvrBocTJGKapChcbwQ0&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=instagram.fccu5-1.fna&_nc_gid=DulPrXGVONizBaD8wcLSaA&oh=00_AftvHhBxP6_u6imMwlM8f-1VP-n2Iyg-3fzRpiKfmsFJtA&oe=69A27CE0', icon: Gamepad2 },
  // Prompters
  { event: 'Prompters', name: 'Senjuti Mondal', phone: '+91 7501558111', email: 'senjutim3@gmail.com', instagram: '@tech_kabita', imageUrl: 'https://instagram.fccu5-1.fna.fbcdn.net/v/t51.82787-15/559008498_17944222005056915_57550811318062861_n.webp?_nc_cat=103&ig_cache_key=MzczNDQyNDA2MTQzNTc2NzI4Mg%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjE0NDB4MTQ0MC5zZHIuQzMifQ%3D%3D&_nc_ohc=1hFUFm-cCqcQ7kNvwFm4Oxz&_nc_oc=Adk1T--b7sgFlrerCSw9vlWUKG9-mVCArgarARIufQNFXkME1rd921q0KScF8fLDexM&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=instagram.fccu5-1.fna&_nc_gid=8W55z1wIh9KlESTa95xPWg&oh=00_AftgMLbLps6iS1EnJXYbotVeWcYP9NNg9oFuWGpxPjF6YQ&oe=69A289DD', icon: Lightbulb },
  { event: 'Prompters', name: 'Neel Das', phone: '+91 7384007265', email: 'neeldas0032@gmail.com', instagram: '@neel_0032', imageUrl: 'https://instagram.fccu5-1.fna.fbcdn.net/v/t51.82787-15/629529796_18074312927604312_4775551130076923041_n.webp?_nc_cat=107&ig_cache_key=MzgyODg1ODQwMDQ5MTYwMzU0MA%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjEwODB4MTQ0MC5zZHIuQzMifQ%3D%3D&_nc_ohc=EjQAA4EGuNYQ7kNvwFLASBv&_nc_oc=AdkDxvXmjrV82xeL7VQQakM2DXJHVkV_31jsK4UqG5sX2d9RfQHiZiN1tEZoNn1QTdk&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=instagram.fccu5-1.fna&_nc_gid=V5Ef0TANMTC8twFPAUs2dQ&oh=00_AfuXZYxaiHjWEqUzrW8u58tq8Dfa6Bu1deWXy37rr3w-YQ&oe=69A25D41', icon: Lightbulb },
  // Bluster
  { event: 'Bluster', name: 'Sanchita Kandar', phone: '+91 9339483883', email: 'sanchita.kandar1971@gmail.com', instagram: '@sanchita.9893', imageUrl: 'https://instagram.fccu5-1.fna.fbcdn.net/v/t51.75761-15/481371601_18039151619605240_3876552901872997220_n.webp?_nc_cat=101&ig_cache_key=MzU3NDAyMDc4NjcxMTYzODAyMQ%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjEwODB4MTA4MC5zZHIuQzMifQ%3D%3D&_nc_ohc=lK9BzHSZdbEQ7kNvwGSEw5O&_nc_oc=AdkJfC8IVQa5pUXUPVa6kj12EmUDMrwYLYw67fXCwW7Qx6KRz9u5EaNfouo16w_F4Tg&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=instagram.fccu5-1.fna&_nc_gid=vfylsAl84GZNz4e8QXHb4A&oh=00_AfvhSYl8r96MFNPa_oxIAi7vBC_Jz1bWNlSlR_eeAzQJ1g&oe=69A257F6', icon: Code },
  { event: 'Bluster', name: 'Ritesh Singh', phone: '+91 8905485844', email: 'muqadarkasikandar03@gmail.com', instagram: '@_singh__ritesh_', imageUrl: 'https://instagram.fccu5-1.fna.fbcdn.net/v/t51.82787-15/617563681_17898674430365488_790195202893536669_n.webp?_nc_cat=107&ig_cache_key=MzUzNTg3MDcxOTY1NjE0NTUwNA%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjE0NDB4MTQ0MC5zZHIuQzMifQ%3D%3D&_nc_ohc=7aUwjhpxMQYQ7kNvwE9OQ_i&_nc_oc=AdlPqat_mlNXl5V8jRZiIeRDfiUw9wJfj5DkYlnZbxCkR6Agj-H0lZ-RuqzVzidZFr8&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=instagram.fccu5-1.fna&_nc_gid=cBjU3AR1yXumrpXLHt2LCg&oh=00_AfutC7biagl7KkLsxWT8NA_NF6LPL6CH5M_wD-L1F9RuUg&oe=69A26272', icon: Code },
  // Architect
  { event: 'Architect', name: 'Moupriya Kundu', phone: '+91 9832986918', email: 'moupriyakundu139@gmail.com', instagram: '@lovely_moupriya', imageUrl: 'https://instagram.fccu5-1.fna.fbcdn.net/v/t51.82787-15/535855865_18058918955601682_5868388197119785954_n.jpg?stp=dst-jpg_e35_tt6&_nc_cat=101&ig_cache_key=MzcwNDI1MDY5MzMyODAwMTcwNA%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjE0NDB4MTg5Ny5zZHIuQzMifQ%3D%3D&_nc_ohc=14t8Kj61jtQQ7kNvwEPjiZi&_nc_oc=AdmSIZiQ1bsfxtqKsadNUPyWPPMR3zFtX8zQ22GZ3XEEVIUcIT1kgp8IvqII_yAP3Kg&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=instagram.fccu5-1.fna&_nc_gid=zvsDL3c0k4U3c6kqiHvQ_Q&oh=00_AfvnSuPjV3wYnwD0YxWYOsBhsNKUd7RFGwtVCZ2vSTsKFA&oe=69A287F8', icon: Cpu },
  { event: 'Architect', name: 'Rounak Bhanja', phone: '+91 9830052068', email: 'rounak2002bhanja@gmail.com', instagram: '@the_tech_hippie', imageUrl: 'https://media.licdn.com/dms/image/v2/D4D03AQEi-qtv-nYwZA/profile-displayphoto-scale_400_400/B4DZpVYcs3IEAs-/0/1762369064429?e=1773273600&v=beta&t=FQRYlxAlXdOB1PJYTfFAXlwiLh35OkRzKHy1CKOWlU8', icon: Cpu },
];
          ...
          >
            <div className="relative inline-block">
              <motion.div
                ...
                className="w-20 h-20 rounded-3xl bg-gradient-to-br from-[#a855f7]/20 to-[#00d4ff]/20 border border-white/[0.1] backdrop-blur-xl flex items-center justify-center"
              >
        ...
        */}
        ...
        <section className="mb-12 sm:mb-16">
          ...
          <div className="flex justify-center">
            {/* <ComingSoonCard title="Lead Developer" delay={0} /> */}
            ...
            {/* <ComingSoonCard title="Lead Designer" delay={0.2} /> */}
          </div>
        </section>
