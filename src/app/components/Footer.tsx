...
import { Calendar, MapPin, Users, Mail, MessageCircle, Instagram, Linkedin, MessageSquare } from 'lucide-react';
        ...
        <div className="grid grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="col-span-1 text-center sm:text-left">
            ...
            <div className="space-y-1 sm:space-y-2 text-[10px] sm:text-sm text-white/60">
              ...
              <Link to="/#contact-us" className="flex items-center justify-center sm:justify-start gap-1 sm:gap-2 hover:text-[#00d4ff] transition-colors group">
                <MessageCircle className="size-3 sm:size-4 group-hover:animate-pulse" />
            ...
            <div className="mt-3 sm:mt-4">
              <div className="font-mono text-[#00d4ff] mb-2 text-xs">
                <span className="text-[#00ffff]">//</span> Follow_Us
              </div>
              <div className="flex items-center justify-center sm:justify-start gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 rounded-full bg-white/5 hover:bg-[#a855f7]/20 transition-colors"
                  title="Instagram"
                >
                  <Instagram className="size-4 text-[#00d4ff]" />
                </a>
                <a
                  href="https://www.linkedin.com/company/texibition/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 rounded-full bg-white/5 hover:bg-[#a855f7]/20 transition-colors"
                  title="LinkedIn"
                >
                  <Linkedin className="size-4 text-[#00d4ff]" />
                </a>
                <a
                  ...
                  title="Discord"
                >
                  <MessageSquare className="size-4 text-[#00d4ff]" />
                </a>
              </div>
            </div>
          </div>
